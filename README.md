In this project, let's build a **Gradient Generator** by applying the concepts we have learned till now.

### Link to the page is given below:
https://mkgradientgen.ccbp.tech/
...
- [Extra Small (Size < 576px) and Small (Size >= 576px)](https://assets.ccbp.in/frontend/content/react-js/gradient-generator-sm-output.png)
- [Medium (Size >= 768px), Large (Size >= 992px) and Extra Large (Size >= 1200px)](https://assets.ccbp.in/frontend/content/react-js/gradient-generator-lg-output.png)
...
**The following HTML attributes are required for the tests to pass.**

- Add **data-testid** with the value **gradientGenerator** to the HTML container element, to which linear gradient values are applied.
